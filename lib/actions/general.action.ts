  ...
  try {
    ...
    const {
      ...
      prompt: `
        ...
        If there is no transcript provided above - the candidate did not answer any questions, so give evaluation with all 0 scores and recommendations on how to answer questions in interview.
